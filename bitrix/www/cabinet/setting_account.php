        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content bd-0 tx-14">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button"  onclick="changeAccount()" class="btn btn-warning tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Да</button>
                    <button type="button" class="btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-dismiss="modal">Нет</button>
                </div>
            </div>
        </div><!-- modal-dialog -->
    </div><!-- modal -->
    ...
    <div id="modaldelete" class="modal fade">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content bd-0 tx-14">
                ...
                <div class="modal-footer justify-content-center">
                    <button type="button" onclick="deleteAccount()" class="btn btn-warning tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Да</button>
                    <button type="button" class="btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-dismiss="modal">Нет</button>
                </div>
            </div>
        </div><!-- modal-dialog -->
    ...
    <!-- ########## START: MAIN PANEL ########## -->
        ...
        <div class="br-pagebody">
            <div class="br-section-wrapper">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Добавление аккаунта</h6>
                ...
                <div class="row">
                    ...
                    <div class="col-lg">
                        <a href="#" onclick="addAccount()" class="btn btn-success tx-11  tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Добавить</a>
                    </div>
                </div><!-- row -->
                <script>
                    accounts=[];
                ...
                <div class="row">
                    <div class="col-lg">
                            <select class="form-control select2 select2-hidden-accessible" id="accountsMenuDefault" aria-hidden="true">
                            </select>
                    </div><!-- col -->

                    <div class="col-lg">
                        <a href="#" onclick="setDefaultAccount()" class="btn btn-success tx-11  tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Установить</a>
                    </div>
                </div><!-- row -->
                <p class="mg-b-25 mg-lg-b-50"></p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg" id="accountDiv">
                        ...
                        <a href="" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-toggle="modal" data-target="#modalchange">Изменить</a>
                        <a href="" class="btn btn-warning tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"  data-toggle="modal" data-target="#modaldelete">Удалить</a>
                    </div><!-- row -->
            </div>
        </div>
    <script>
